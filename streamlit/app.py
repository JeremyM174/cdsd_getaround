...
def calculate_delay_impact_data(data_delay_rentals):
    #filter consecutive rentals (previous_ended_rental_id > 0)
    ...
    #extract how late previous_ended_rental_id checkout was into delay_at_checkout_in_minutes
    ...
    #filter rentals where previous one was late on checkout
...
def rental_analysis_page():
    ...
    #compute unique rentals, without further bookings
    ...
    #filter by interval (slider for numerical column)
    ...
    #filter applies to non-NaN data
